...
p1 = ggplot(data[data$Architecture == "Monolith",], aes(x = Technology, y = Elapsed)) + 
...
p2 = ggplot(data[data$Architecture == "Microservices",], aes(x = Technology, y = Elapsed)) + 
  geom_boxplot(fill = c("lightgreen")) +
  facet_wrap(~Route, ncol = 1) +
  xlab("") +
  ylab("") +
...
p1 = ggplot(data[data$Route == "Route1",], aes(x = Technology, y = Elapsed)) + 
  geom_boxplot(fill = c("lightgreen")) +
...
p2 = ggplot(data[data$Route == "Route2",], aes(x = Technology, y = Elapsed)) + 
  geom_boxplot(fill = c("lightgreen")) +
  facet_wrap(~Architecture, ncol = 1) +
  xlab("") +
  ylab("") +
